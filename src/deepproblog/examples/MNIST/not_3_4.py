...
def not_3_4(n: int, dataset: str, seed=None):
...
name = "not_3_4{}_{}_{}".format(method, N, args.seed)

train_set = not_3_4(N, "train")
test_set = not_3_4(N, "test")
...
model = Model("models/not_3_4.pl", [net])
if method == "exact":

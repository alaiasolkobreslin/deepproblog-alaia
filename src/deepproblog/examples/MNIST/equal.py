...
def equal(n: int, dataset: str, seed=None):
...
name = "equal_test{}_{}_{}".format(method, N, args.seed)

train_set = equal(N, "train")
test_set = equal(N, "test")
...
model = Model("models/equal.pl", [net])
if method == "exact":
